          ...
          <div>
            ...
            <div className="flex gap-3">
              <TrackedLink
                ...
                gtmEvent={{ event: "social_click", platform: "facebook", click_source: "footer" }}
              >
              ...
              <TrackedLink
                ...
                gtmEvent={{ event: "social_click", platform: "instagram", click_source: "footer" }}
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <address className="not-italic space-y-3">
              ...
              <TrackedLink
                ...
                style={{ color: "#8a7a6a" }}
                gtmEvent={{ event: "phone_click", click_source: "footer" }}
              >
              ...
              <TrackedLink
                ...
                style={{ color: "#D89B3C" }}
                gtmEvent={{ event: "directions_click", click_source: "footer" }}
              >
                Get Directions →
              </TrackedLink>
            </address>
